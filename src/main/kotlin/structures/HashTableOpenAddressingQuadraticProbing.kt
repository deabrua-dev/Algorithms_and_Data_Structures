...
class HashTableOpenAddressingQuadraticProbing<T, R>(private var capacity: Int = 0) {
    ...
    fun push(key: T, value: R) {
        ...
        while (
            ...
            hashIndex = (hashIndex + (magicConstant + (magicConstant * magicConstant)) / 2) % this.capacity
            magicConstant++
        }
        if (
            this.map[hashIndex] == null &&
